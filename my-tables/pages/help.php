...
<p>Plugin helping WordPress Developers - by <a href="http://bimal.org.np/">Bimal Poudel</a> | <code>SHOW TABLE STATUS;</code> in: <a href="http://dev.mysql.com/doc/refman/5.7/en/show-table-status.html">MySQL</a> | <a href="https://mariadb.com/kb/en/mariadb/show-table-status/">MariaDB</a>.</p>
...
<div>
	<p>The list is sorted by table size. <a href="https://gist.github.com/bimalpoudel/16d3539bed6e55879c00ff1c71ac63ff#file-sizes-per-tables-sql">View SQL Details</a>.</p>
</div>
<?php
$mtp = new my_tables_processor();
